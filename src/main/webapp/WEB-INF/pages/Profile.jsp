      ...
      <section class="profile-section">
        ...
        <form class="profile-form"
          ...
          <div class="input-cell">
            <input id="username" name="username" type="text" value="<c:out value='${profile.username}'/>"/>
          </div>

          <!-- Name -->
          <div class="label-cell"><label for="name">Name</label></div>
          <div class="input-cell">
            <input id="name" name="name" type="text" value="<c:out value='${profile.name}'/>"/>
          </div>
          ...
          <div class="input-cell with-icon">
            ...
            <input id="email" name="email" type="email" value="<c:out value='${profile.email}'/>"/>
          </div>

          <!-- About -->
          <div class="label-cell"><label for="about">About</label></div>
          <div class="input-cell">
            <input id="about" name="about" type="text" value="<c:out value='${profile.about}'/>"/>
          </div>
