...
<head>
  <meta charset="UTF-8"/>
  <title>Buyer Sidebar – Cognix</title>
  <style>
    /* === Reset & Base === */
...
<aside class="sidebar">
  <div>
    ...
    <div class="sidebar__logo">
      <img src="${pageContext.request.contextPath}/nav-icons/buyer-logo.svg" alt="Buyer Logo"/>
    </div>
    ...
    <ul class="nav-list">
      ...
      <li class="nav-item ${param.currentPage=='models'?'active':''}">
        <a href="${pageContext.request.contextPath}/BuyerModel?currentPage=models">
          <img class="icon" src="${pageContext.request.contextPath}/nav-icons/Folder.svg" alt="Models"/>
          <span>Models</span>
        </a>
      </li>
      <li class="nav-item ${param.currentPage=='cart'?'active':''}">
        <a href="${pageContext.request.contextPath}/BuyerOder?currentPage=cart">
          <img class="icon" src="${pageContext.request.contextPath}/nav-icons/shopping-cart.svg" alt="Cart"/>
          <span>Cart</span>
        </a>
      </li>
      <li class="nav-item ${param.currentPage=='mymodels'?'active':''}">
        <a href="${pageContext.request.contextPath}/BuyerMyModel?currentPage=mymodels">
          <img class="icon" src="${pageContext.request.contextPath}/nav-icons/File.svg" alt="My Models"/>
          <span>My Models</span>
        </a>
      </li>
    </ul>
  ...
  <c:set var="avatarUrl" value="${not empty sessionScope.user.profilePicture 
